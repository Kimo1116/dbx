...
export const RIGHT_SIDEBAR_PANEL_IDS = ["ai", "history", "sqlLibrary", "sqlFile", "review", "aiReview"] as const;
...
function normalizeToolbarItems(items: Partial<ToolbarItems> | undefined): ToolbarItems {
  ...
  return {
    ...
    review: items.review ?? defaults.review,
    aiReview: items.aiReview ?? defaults.aiReview,
